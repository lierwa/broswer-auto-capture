...
export const taskSummarySchema = taskMetaSchema.extend({ status: z.enum(["new", "running", "answer", "draft", "confirmed", "failed", "planning", "plan_ready", "queued", "executing", "review"]), revision: z.number().int() })
...
export const taskStatusLabels: Record<TaskSummary["status"], string> = { new: "新需求", running: "正在处理", answer: "待回答", draft: "待确认草稿", confirmed: "需求已确认", failed: "本轮未完成", planning: "正在制定计划", plan_ready: "待确认计划", queued: "授权排队中", executing: "浏览器处理中", review: "计划或运行待复核" }
